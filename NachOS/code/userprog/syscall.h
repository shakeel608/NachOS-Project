...
// The parameter arg is  a pointer to the arguments which the  function pointed by f will execute
//Returns integre value if it succeeds otherwise returns null
