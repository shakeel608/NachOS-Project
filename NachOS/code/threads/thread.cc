...
//Oscar's Comment: IF YOU SEE THIS YOU PULL THE BRANCH CORRECTLY
//Oscar's comment: second test
//Sannaras comments

 //Shakeel's Comment: Shakeel's first Comment
  //Shakeel's  second Comment: Testing Git
...
Thread::Thread (const char *threadName)
{
    ...
    for (int r=NumGPRegs; r<NumTotalRegs; r++)
      userRegisters[r] = 0;
    tid = -1; //the thread dont have a tid yet
#endif
}
