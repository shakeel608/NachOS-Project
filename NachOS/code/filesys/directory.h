...
class Directory {
  public:
    ...
    bool AddSubdirectory(const char *name, int newSector);
    // Add Subdirectory name in the current directory table

    bool IsDirectory(const char *name); //check if the name is a directory
